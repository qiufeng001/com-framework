package com.framework.manager.impl;

import com.framework.core.base.UUID;
...
public abstract class BaseManager<T extends IEntity, K> implements IManager<T, K> {
