package com.framework.core.contants;
...
public interface RedisKey {
    ...
    //用户互踢用
    String UC_ALREADY_LOGIN = "UC" + Constant.REDIS_DIVISION
            + "ALREADY" + Constant.REDIS_DIVISION
            + "LOGIN";
    //绑定邮箱的redis key
    String UC_BIND_Email = "UC" + Constant.REDIS_DIVISION
            + "BIND" + Constant.REDIS_DIVISION
            + "Email";
    //忘记密码图形验证码的redis key
    String UC_LOGIN_FORGET_VERIFY_CODE = "UC" + Constant.REDIS_DIVISION
            + "LOGIN" + Constant.REDIS_DIVISION
            + "FROGET" + Constant.REDIS_DIVISION
            + "VERIFY" + Constant.REDIS_DIVISION
            + "CODE";
    String UC_BING_MOBILE_VERIFY_CODE = "UC_BING_MOBILE_VERIFY_CODE_";
    //session存放的redis key
    String UC_LOGIN_SESSION = "UC" + Constant.REDIS_DIVISION
            + "LOGIN" + Constant.REDIS_DIVISION
            + "SESSION";
    //存放练习添加的人员
     ...
     * 验证是否能够上传的key
     */
    String UPLOAD_LOCK = "UPLOAD_LOCK";

    /**
     * 将ppt转换成pptx格式的队列
     */
    String PPT_CONVERT_QUEUE = "PPT_CONVERT_QUEUE";

    /**
     * 将 word 转成 pdf 队列
     */
    String WORD_TO_PDF_QUEUE = "WORD_TO_PDF_QUEUE";

    /**
     * 需要将ppt中的shape转换成图片保存的队列
     */
    String CONVERT_FAIL_QUEUE = "convertfailqueue";

    /**
     * 转换错误的名称
     */
    String SHAPE_CONVERT_QUEUE = "SHAPE_CONVERT_QUEUE";

    String PE_SCENE_GENERATING_ITEM_COUNT_ = "PE_SCENE_GENERATING_ITEM_COUNT_";
    String PE_PPT_IMPORT_STATUS_ = "PE_PPT_IMPORT_STATUS_";
}